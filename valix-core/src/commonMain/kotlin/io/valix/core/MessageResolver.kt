...
interface MessageResolver {
     ...
     */
    fun resolve(key: String, locale: ValixLocale, params: Map<String, Any> = emptyMap()): String
}
...
object NoOpMessageResolver : MessageResolver {
    override fun resolve(key: String, locale: ValixLocale, params: Map<String, Any>): String = key
}
